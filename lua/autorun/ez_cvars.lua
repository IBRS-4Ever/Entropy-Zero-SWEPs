...
CreateConVar( "sk_ez_infinite_ammo", 0 , FCVAR_SERVER_CAN_EXECUTE, "Infinite ammo.", 0, 1)
CreateConVar( "sk_ez_no_recoil", 0 , FCVAR_SERVER_CAN_EXECUTE, "No Recoil.", 0, 1)
CreateConVar( "sk_ez_no_bullet_spread", 0 , FCVAR_SERVER_CAN_EXECUTE, "No Bullet Spread.", 0, 1)